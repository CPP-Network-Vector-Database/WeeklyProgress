...
collection = client.get_or_create_collection(name="distilroberta_cosine", embedding_function=SentenceTransformerEmbeddingFunction(), metadata={"hnsw:space": "cosine"})
